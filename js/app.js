...
let spal = document.querySelector('.spalv');
...
function rand(min, max) {
 ...
 function rand3() {
     for (let i = 0 ; i < 1 ; i++)
    masyvas.push(Math.floor(Math.random() * (b - a)) + a);
    return masyvas;
 }

 const australia = ['Kengūra', 'Ančiasnapis', 'Dingo', 'Atsirado', 'Strutis'];
const btn4 = document.getElementById('btnas')
 btn3.addEventListener('click',function(){
    h4.innerHTML=australia;
 })